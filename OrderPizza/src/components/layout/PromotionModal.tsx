...
const Option = styled.div<{ $selected: boolean; $disabled: boolean }>`
  ...
  border: 1px solid ${(props) =>
      props.$disabled
        ...
        ? props.theme.colors.primary[500]  
        : props.theme.colors.neutral[200]};
  background-color: ${(props) => (props.$disabled ? props.theme.colors.neutral[100] : props.theme.colors.white)};
  display: flex;
  justify-content: center;
  align-items: center;
  border-radius: 10px;
  ...
  &:hover {
    ...
    border: 1px solid ${(props) => props.$selected ? props.theme.colors.primary[500] : props.theme.colors.neutral[500]};
  }
      ...
      <Container>
        ...
        <OptionsContainer>
            <Option    
              ...
              onClick={() => {setSelectedOption("B2G1"); disabledOptions.includes("B2G1") ? setAlert("This option is disabled") : setAlert(null)}}
            >
            <span className="B2G1">BUY 2 GET 1</span><span className="B2G1-free">FREE</span>
            <span className="code">Code: B2G1</span>
            </Option>
            <Option
              $selected={selectedOption === "PROMO20"}
              $disabled={disabledOptions.includes("PROMO20")}
              onClick={() => {setSelectedOption("PROMO20"), disabledOptions.includes("PROMO20") ? setAlert("This option is disabled") : setAlert(null)}}
            >
            ...
            <Option 
              ...
              onClick={() => {setSelectedOption("PROMO30"), disabledOptions.includes("PROMO30") ? setAlert("This option is disabled") : setAlert(null)}}
            >
            ...
            <Option 
              ...
              onClick={() => {setSelectedOption("PROMO40"), disabledOptions.includes("PROMO40") ? setAlert("This option is disabled") : setAlert(null)}}
            >
        ...
        <Footer>
          ...
          <div>
            <Button buttonType="textBlack" onClick={onClose}>Cancel</Button>
