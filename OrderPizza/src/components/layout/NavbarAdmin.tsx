    ...
    <Container>
        ...
        <div className="navlist-container">
          <NavList>
            ...
            <li><StyledNavLink to='/orders-management'><img src={ordersManagementIcon} alt=''/>Orders management</StyledNavLink></li>
          ...
          <div>
            <Button style={{ width: "100%", justifyContent: "flex-start" }} buttonType="secondary" iconLeft={logoutIcon} onClick={logout}>Log out</Button>
            <Button style ={{width: "100%"}} buttonType="primary" onClick={() => navigate("./")}>Go to public site</Button>
          </div>
