        ...
        <p>
          {type === 'B2G1' ? (
            <span className="details">
              Buy 3 pizzas and the cheapest one you get for free.{' '}
            </span>
          ) : (
            <span className="details">Discount on total value. </span>
          )}
          <span className="details">{`Use discount code "${type === 'B2G1' ? 'B2G1' : `${type}`}" in the cart.`}</span>
        </p>
        <div>
