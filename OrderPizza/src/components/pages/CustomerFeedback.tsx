...
const divWidth = (reviews: Array<Review> | null, value: number) => {
  if (reviews) {
    const countRating: number = reviews.reduce(
      (accumulator, currentValue) =>
        currentValue.stars === value ? accumulator + 1 : accumulator,
      0
    );
      ...
      <PageContainer title="Customer feedback">
        <PageContent>
          <TotalReviews>
            <div className="review-average">
              <div>
                ...
                <p className="rating">
                  {reviews ? calculateAverageRating(reviews) : 0}
                </p>
              </div>
              <p className="reviews">
          ...
          <SectionContainer title="Leave feedback">
            <p>
              Share your feedback with us and help us improve our services. Your
              feedback will be sent anonymously.
            </p>
            <FeedbackForm onSubmit={handleSubmit}>
              ...
              <div className="stars-container">
                {ratings.map((e) => (
                  <Star
                    key={e}
                    className={
                      (feedbackFormData.selectedStars !== null &&
                        e <= feedbackFormData.selectedStars) ||
                      (stars !== null && e <= stars)
                        ? 'active'
                        : ''
                    }
              ...
              <div className="textarea-container">
                ...
                />
                <p>
                  Characters left: {200 - feedbackFormData.feedbackText.length}
                </p>
              </div>
            ...
            <FeedbackContainer>
              {reviews && reviews.length > 0 ? (
                reviews.map((review, index) => (
                  <Feedback key={review.id ?? index} {...review} />
                ))
              ) : (
