    ...
    <Container>
      ...
      <QualitySection>
        <div className="quality-item">
          ...
          <div>
            ...
            <p>
              We import high-quality Italian ingredients from sauces to cheese,
              hams and much more.
            </p>
          </div>
        </div>
        <div className="quality-item">
          ...
          <div>
            ...
            <p>
              Our pizza is made from an old recipe created by a famous Italian
              pizza master.
            </p>
          </div>
        </div>
        <div className="quality-item">
          ...
          <div>
            ...
            <p>
              You will always get warm and delicious pizza. Our energetic team
              provides very fast delivery.
            </p>
          </div>
        </div>
      </QualitySection>
      ...
      <AboutUsSection>
        <div className="description">
          <h2>About Us</h2>
          <p>
            We are a small restaurant in the center of Warsaw focused on
            perfecting the art of pizza. Our pizza is made from an old recipe
            created by a famous Italian pizza master. We continuously improve
            our recipe to provide you with high-quality products. We use only
            the best ingredients, imported from Italy and produced by local
            farmers. We can ensure that you will always get warm and delicious
            pizza. Our energetic team provides very fast delivery.
          </p>
          <div>
