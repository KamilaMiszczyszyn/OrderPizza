...
type ActionReducer = {
  type: 'alphabeticalAZ' | 'alphabeticalZA' | 'recencyDESC' | 'recencyASC';
};
          ...
          <div className="options">
            ...
            <SortOption>
              ...
              {sortOption && (
                <Dropdown>
                  <DropdownItem
                    onClick={() => dispatch({ type: 'alphabeticalAZ' })}
                  >
                    Alphabetical (A-Z)
                  </DropdownItem>
                  <DropdownItem
                    onClick={() => dispatch({ type: 'alphabeticalZA' })}
                  >
                    Alphabetical (Z-A)
                  </DropdownItem>
                  <DropdownItem
                    onClick={() => dispatch({ type: 'recencyDESC' })}
                  >
                    By recency (Oldest to newest)
                  </DropdownItem>
                  <DropdownItem
                    onClick={() => dispatch({ type: 'recencyASC' })}
                  >
